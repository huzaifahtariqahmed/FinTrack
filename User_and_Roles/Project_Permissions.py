...
class PERMISSION(QtWidgets.QMainWindow):
    ...
    def editPermissionSettings(self):
        #Load the .ui file
        uic.loadUi('Project_EditPermissionSettings.ui', self)
    ...
    def addPermission(self):
        uic.loadUi('Project_NewPermission.ui', self)
...
class USER(QtWidgets.QMainWindow):
    ...
    def User_DataTable(self):
        # Load the .ui file
        uic.loadUi('Project_UserAccessControl.ui', self)
    ...
    def add(self):
        ...
        uic.loadUi('Project_NewUser.ui', self)
        # Clear previous content if needed
    ...
    def addRole(self):
        uic.loadUi('Project_NewJobRole.ui', self)
        # Clear previous content if needed
    ...
    def editRoleSettings(self):
        #Load the .ui file
        uic.loadUi('Project_EditRoleSettings.ui', self)
